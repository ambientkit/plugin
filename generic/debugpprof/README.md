...
**Import:** github.com/ambientkit/plugin/generic/debugpprof
...
- **Name**: router.route:write
  - **Description**: Access to create routes for accessing debug information.
...
The plugin has the following routes (2):
  ...
  - **Method:** GET | **Path:** /debug/pprof/{pprof}
