...
This repository contains a standard set of plugins for Ambient.

You can read why the Ambient framework was created [here](https://github.com/ambientkit/ambient#what-is-it). A quickstart is available in the [ambient-template repository](https://github.com/ambientkit/ambient-template).

This guide will walk you through creating a plugin.
