module github.com/ambientkit/plugin
...
require (
	...
	github.com/ambientkit/ambient v0.0.0-20220301103736-ec8be59ec491
	github.com/ambientkit/away v0.0.0-20220309132846-7304283c8457
